...
{
    public class HubspotHttpClientService: IHubspotHttpClientService
    {
        private readonly IOptions<HubSpotSettings> hubspotSettings;        private readonly IHttpClientService httpClientService;
        private readonly HttpClient _httpClient = null;        public HubspotHttpClientService(IOptions<HubSpotSettings> hubspotSettings, IHttpClientService httpClientService)        {            this.hubspotSettings = hubspotSettings;
